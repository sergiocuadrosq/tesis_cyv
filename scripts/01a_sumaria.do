...
save "$processed/1_panel/2011-2012/2011-2012_sumaria.dta", replace
...
save "$processed/1_panel/2012-2013/2012-2013_sumaria.dta", replace
...
save "$processed/1_panel/2014-2015/2014-2015_sumaria.dta", replace
...
save "$processed/1_panel/2015-2016/2015-2016_sumaria.dta", replace
...
save "$processed/1_panel/2016-2017/2016-2017_sumaria.dta", replace
...
save "$processed/1_panel/2017-2018/2017-2018_sumaria.dta", replace
...
save "$processed/1_panel/2018-2019/2018-2019_sumaria.dta", replace
...
save "$processed/1_panel/2019-2020/2019-2020_sumaria.dta", replace
